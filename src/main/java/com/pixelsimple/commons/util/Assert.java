 ...
 * 
 * <p>
 * For example, if the contract of a public method states it does not allow <code>null</code>
 ...
 * 
 * <pre class="code"> Assert.notNull(clazz, "The class must not be null"); Assert.isTrue(i > 0,
...
public abstract class Assert {
	...
	/**
	 * Assert that the given text does not contain the given substring. <pre
	 * class="code">Assert.doesNotContain(name, "rod", "Name must not contain 'rod'");</pre>
	 * 
	 * @param textToSearch
	 *            the text to search
	 * @param substring
	...
	/**
	 * Assert that a string has valid text content; that is, it must not be <code>null</code> and
	 * must contain at least one non-whitespace character. <pre class="code">Assert.hasText(name,
	...
	/**
	 * Assert that <code>superType.isAssignableFrom(subType)</code> is <code>true</code>. <pre
	 * class="code">Assert.isAssignable(Number.class, myClass);</pre>
	 * 
	 * @param superType
	 ...
	 *            the sub type to check
	 * @param message
	 *            a message which will be prepended to the message produced by the function itself,
	 *            and which may be used to provide context. It should normally end in a ": " or ". "
	...
	/**
	 * Assert that an object is <code>null</code> . <pre class="code">Assert.isNull(value);</pre>
	 * 
	 * @param object
	 *            the object to check
	 * @throws IllegalArgumentException
	...
	/**
	 * Assert that an object is <code>null</code> . <pre class="code">Assert.isNull(value,
	 ...
	 * result is <code>false</code>. <pre class="code">Assert.isTrue(i &gt; 0);</pre>
	 * 
	 * @param expression
	...
	/**
	 * Assert a boolean expression, throwing <code>IllegalArgumentException</code> if the test
	 * result is <code>false</code>. <pre class="code">Assert.isTrue(i &gt; 0,
	 * "The value must be greater than zero");</pre>
	 * 
	 * @param expression
	 *            a boolean expression
	 ...
	 * have at least one element. <pre class="code">Assert.notEmpty(collection,
	 ...
	 * least one entry. <pre class="code">Assert.notEmpty(map);</pre>
	 * 
	 * @param map
	 *            the map to check
	 * @throws IllegalArgumentException
	...
	/**
	 * Assert that a Map has entries; that is, it must not be <code>null</code> and must have at
	 * least one entry. <pre class="code">Assert.notEmpty(map, "Map must have entries");</pre>
	 * 
	 * @param map
	 *            the map to check
	 * @param message
	 ...
	 * least one element. <pre class="code">Assert.notEmpty(array);</pre>
	 * 
	 * @param array
	 *            the array to check
	 * @throws IllegalArgumentException
	...
	/**
	 * Assert that an array has elements; that is, it must not be <code>null</code> and must have at
	 * least one element. <pre class="code">Assert.notEmpty(array,
	 ...
	 * assertion failure. <pre class="code">Assert.state(id == null);</pre>
	 * 
	 * @param expression
	 *            a boolean expression
	 ...
	 * assertion failure. <pre class="code">Assert.state(id == null,
